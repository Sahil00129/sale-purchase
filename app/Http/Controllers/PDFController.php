...
class PDFController extends Controller
{
    public function generatePDF()
    {
       ...
       // echo'<pre>'; print_r($site_id);die;
        ...
        $list =  DB::table('item_master')->where('common_name', $_POST['packing'])->where('group', $_POST['group'])->get();
        $rs = $list->toArray();
        $items = array();
        foreach($rs as $item) {
            $items[] = $item->common_name;
        }
        $uni = array_unique($items);
        ...
        foreach($uni as $item){
            $i++;
            $getGrp =  DB::table('item_master')->select('group', 'poi', 'regis_no', 'pack')->where('common_name', $item)->get();;
            $rs = json_decode(json_encode($getGrp), true);
            $getGP = call_user_func_array('array_merge', $rs);
            //echo "<pre>"; print_r($getGP);die;
 
           $saleData = saleData::where('common_name', $item)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();
 
           $purchaseData = purchaseData::where('common_name', $item)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();
 
           $stock_trf = StockTransfer::where('common_name', $item)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();
         ...
         $dd = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
             ...
             if($flag == 1){
                             ...
                             $opening = DB::table('stock_opening')->where('common_name', $inm)->where('site_id',  $site_id)->where('identity',$identity)->where('client',$client)->whereDate('fy', '<', $opb_date)->get();
             ...
             /*********************************** Get opening balance from Sale Data *****************************************/
                   ...
                   $preData['sale']= DB::table('sale_data')->where('common_name', $inm)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$opb_date,$lastDay])->get();
 
                   $preData['purchase']= DB::table('purchase_data')->where('common_name', $inm)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$opb_date,$lastDay])->get();
 
                   $preData['stock_trf']= DB::table('stock_transfer')->where('common_name', $inm)->where('site_id', $site_id)->where('identity',$identity)->where('client',$client)->whereBetween('bill_date',[$opb_date,$lastDay])->get();
  ...
  public function allinone()
  {
    ...
    $site_id = $_POST['site_id'];
    $fromDate = $_POST['fromDate'];
    $itemsList =  DB::table('item_master')->select('common_name')->get();
    $saleitems =  DB::table('sale_data')->select('common_name')->distinct()->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->get();
    $puritems =  DB::table('purchase_data')->select('common_name')->distinct()->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->get();
    $trfitems =  DB::table('stock_transfer')->select('common_name')->distinct()->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->get();
    ...
    $finalItems = array_unique(array_column($group_res, 'common_name'));
    ...
    foreach($finalItems as $item){
       ...
       $saleData = saleData::where('common_name', $item)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();

       $purchaseData = purchaseData::where('common_name', $item)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();

       $stock_trf = StockTransfer::where('common_name', $item)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$_POST['fromDate'],$_POST['toDate']])->get();
     ...
     $dd = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
         ...
         /*********************************** Get opening balance from Sale Data *****************************************/
               ...
               $preData['sale']= DB::table('sale_data')->where('common_name', $inm)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$opb_date,$lastDay])->get();

               $preData['purchase']= DB::table('purchase_data')->where('common_name', $inm)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$opb_date,$lastDay])->get();

               $preData['stock_trf']= DB::table('stock_transfer')->where('common_name', $inm)->where('site_id', $site_id)->where('client',$client)->where('identity',$identity)->whereBetween('bill_date',[$opb_date,$lastDay])->get();
