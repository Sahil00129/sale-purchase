                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Purchase Import</a></li>
                             </ol>   
                        </nav>
                                    ...
                                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form id="purchase_import" method="post" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <select id="p_identity" class="form-control" name="identity">
                                                    <option selected disabled>Choose...</option>
                                           ...
                                           <div class="form-row mb-4">         
                                                ...
                                                <select id="p_client" class="form-control" name="client">
                                                    <option selected disabled>Choose...</option>
